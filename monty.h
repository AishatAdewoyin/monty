...
void s_pint(stack_t **stack_head, unsigned int lineNum);
int execute(char *content, stack_t **head, unsigned int lineNum, FILE *file);
void free_stack(stack_t *head);
void s_pop(stack_t **stack_head, unsigned int lineNum);
void s_swap(stack_t **stack_head, unsigned int lineNum);
void s_add(stack_t **head, unsigned int lineNum);
void s_nop(stack_t **head, unsigned int lineNum);
void s_sub(stack_t **head, unsigned int lineNum);
...
void s_rotl(stack_t **head, unsigned int lineNum);
